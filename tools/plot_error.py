...
ax.plot(depth_true, t0_error, label=r'$t_0$')
ax.plot(depth_true, Vrms_error, label=r'$V_{rms}$')
ax.plot(depth_true, depth_error, label='depth')
ax.plot(depth_true, epsilon_error, label=r'$\varepsilon_r$')
ax.plot(depth_true, Vn_error, label=r'$V_n$')
...
error_values = np.array([t0_error, Vrms_error, depth_error, epsilon_error, Vn_error]).T
header = 't0 [%], Vrms [%], depth [%], epsilon [%], Vn [%]'
