...
#* Bottom component
ax[0].plot(rock_size_array, Tb[0] / 1e-9, label='Bottom', linewidth=2)
...
for i in range(3):
    ...
    if i != 0:
        ...
        ax[i].set_ylabel('Initial transmission angle', fontsize=20)
        ax[i].set_ylim(0, np.pi /4)
